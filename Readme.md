...
# PCI_DEVICE=/sys/bus/pci/devices/0000:86:00.0
...
# 
qemu-system-x86_64 \
  -hda ./focal-server-cloudimg-amd64-01.img \
  -m 4G \
  -smp 4 \
  -M pc \
  -cpu host \
  ...
  -vnc :1 \
  -name "MyVM1" \
  -device vfio-pci,sysfsdev=/sys/bus/mdev/devices/383eb40c-1651-4c49-b5b7-f10ea12be79b \
